...
public class CRUD_INFO {
    ...
    public static void CRUD_INFO() {
        ...
        JButton b9 = new JButton("Regresar al inicio");
        b9.setBounds(350, 300, 200, 40);
        ImageIcon inf9 = new ImageIcon("images/inicio.jpg");
        b9.setIcon(new ImageIcon(inf9.getImage().getScaledInstance(50, 50, 5)));

        b9.setBackground(Color.white);//color del fondo del boton
        b9.setForeground(Color.black);//colo de la letra del texto
        b9.setFont(new Font("cooper black", 0, 12));
        b9.setVisible(true);//
        //  b9.addActionListener(this);// Agregamos el boton a nuestra ventana con add
        f1.add(b9);
        /////////
